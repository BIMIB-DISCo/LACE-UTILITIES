...
# perform inference
inference = LACE(D=D,lik_w=lik_w,alpha=alpha,beta=beta,num_rs=50,num_iter=10000,n_try_bs=500,marginalize=FALSE,num_processes=24,seed=1177443,verbose=TRUE)
